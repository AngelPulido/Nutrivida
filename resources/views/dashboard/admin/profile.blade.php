  ...
  <div class="flex min-h-screen bg-gray-50">
    ...
    <main class="flex-1 p-8 overflow-y-auto">
      <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden p-6">
        ...
        <form action="{{ route('dashboard.admin.profile.update') }}"
              method="POST"
          ...
          <div class="mt-6">
            ...
            <div class="mt-1">
              ...
              <div class="flex items-center justify-center w-full">
                <label for="cover_photo" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
